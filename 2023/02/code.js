function main() {
  ...
  for (var i = 0; i < reveals.length; i++) {
    var gamepossible = 1;
    for (var j = 0; j < reveals[i].length; j++) {
      if (reveals[i][j][0] > 12) { gamepossible = 0; }
      if (reveals[i][j][1] > 13) { gamepossible = 0; }
      if (reveals[i][j][2] > 14) { gamepossible = 0; }
    }
    if (gamepossible) { idsum += i + 1 }
  }
  ...
  for (var i = 0; i < reveals.length; i++) {
    ...
    var maxblue = 0;
    for (var j = 0; j < reveals[i].length; j++) {
      if (reveals[i][j][0] > maxred) { maxred = reveals[i][j][0]; }
      if (reveals[i][j][1] > maxgreen) { maxgreen = reveals[i][j][1]; }
      if (reveals[i][j][2] > maxblue) { maxblue = reveals[i][j][2]; }
    }
  ...
  document.getElementById("bongo").innerHTML = answer1;
  document.getElementById("drum").innerHTML = answer2;
